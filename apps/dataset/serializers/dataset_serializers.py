...
class DataSetSerializers(serializers.ModelSerializer):
    ...
    class Create(ApiMixin, serializers.Serializer):
        ...
        @valid_license(model=DataSet, count=100,
                       message=_(
                           'The community version supports up to 100 knowledge bases. If you need more knowledge bases, please contact us (https://fit2cloud.com/).'))
